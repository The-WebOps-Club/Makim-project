    	...
    	<div class="row">
        	...
        	<div class="col-md-10">
                ...
                if(empty($_POST["sec1"]))
                  ...
                  $newdoc=fopen("sec1edit.html","w") or die("Unable to open the file!");
                  $txt=$_POST["sec1"];
                  fwrite($newdoc,$txt);
                  fclose($newdoc);
                  $newdoc2=fopen("sec1edit.html","r") or die("Unable to open the file!");
              ...
              ?>  
                ...
                if(empty($_POST["sec2"]))
                  ...
                  $newdoc=fopen("sec2edit.html","w") or die("Unable to open the file!");
                  $txt=$_POST["sec2"];
                  fwrite($newdoc,$txt);
                  fclose($newdoc);
                  $newdoc2=fopen("sec2edit.html","r") or die("Unable to open the file!");
              ...
              ?>
                ...
                if(empty($_POST["sec3"]))
                  ...
                  $newdoc=fopen("sec3edit.html","w") or die("Unable to open the file!");
                  $txt=$_POST["sec3"];
                  fwrite($newdoc,$txt);
                  fclose($newdoc);
                  $newdoc2=fopen("sec3edit.html","r") or die("Unable to open the file!");
              ...
              ?>
                ...
                if(empty($_POST["sec4"]))
                  ...
                  $newdoc=fopen("sec4edit.html","w") or die("Unable to open the file!");
                  $txt=$_POST["sec4"];
                  fwrite($newdoc,$txt);
                  fclose($newdoc);
                  $newdoc2=fopen("sec4edit.html","r") or die("Unable to open the file!");
              ...
              ?>
                ...
                if(empty($_POST["sec5"]))
                  ...
                  $newdoc=fopen("sec5edit.html","w") or die("Unable to open the file!");
                  $txt=$_POST["sec5"];
                  fwrite($newdoc,$txt);
                  fclose($newdoc);
                  $newdoc2=fopen("sec5edit.html","r") or die("Unable to open the file!");
